...
const Chuong2 = ({ setSelectedItem }: { setSelectedItem: (value: string | null) => void }) => {
    ...
    const [user, setUser] = useState<{ username: string; name: string; phone: string; sex: string; mssv: string; class: string; BT2: number } | null>(null);
...
/>
    ...
    <div className="grade-info">
        <h3>Điểm bài tập</h3>
        <p><strong>Điểm:</strong> {user.BT2 === -1 ? "Chưa chấm" : user.BT2}</p>
    </div>
) }
